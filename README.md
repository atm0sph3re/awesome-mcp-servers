...
- [atm0sph3re/code-health-system](https://github.com/atm0sph3re/code-health-system) 🐍 🏠 - Local Python code health analysis: dead code detection, dependency graphs, and refactoring risk assessment for AI agents.
